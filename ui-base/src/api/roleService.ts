...
class RoleService {
   ...
   */
  async getRole(id: string): Promise<BaseResponse<Role>> {
   ...
   */
  async deleteRole(id: string): Promise<BaseResponse<{ message: string }>> {
   ...
   */
  async restoreRole(id: string): Promise<BaseResponse<Role>> {
